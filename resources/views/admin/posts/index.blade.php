...
@section('content')
        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{route('posts.create')}}" class="btn btn-primary mb-3">Create new</a>
                    @if(count($posts))
                    <table class="table table-bordered table-responsive table-hover text-nowrap">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('posts.edit', $post->id)}}" class="btn btn-info btn-sm float-left ml-1"><i class="fas fa-pencil-alt"></i></a>
                                <form action="{{route('posts.destroy', $post->id)}}" method="post" class="float-left ml-1">
                                    @csrf
                                    @method('DELETE')
