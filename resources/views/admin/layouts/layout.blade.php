...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="/assets/admin/css/alt/adminlte.min.css">
    <link rel="stylesheet" href="/assets/admin/select2/css/select2.min.css">
    <link rel="stylesheet" href="/assets/admin/select2-bootstrap4-theme/select2-bootstrap4.min.css">
    <style>
...
<script src="/assets/admin/select2/js/select2.full.min.js"></script>
<script src="/assets/admin/bs-custom-file-input/bs-custom-file-input.min.js"></script>
<script>
    $(function () {
